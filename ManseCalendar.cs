...
{
    public static class ManseCalendar
    {
        ...
        // 24절기(입춘부터) 및 대응 황경(도)
        static readonly string[] SolarTermNames = ["입춘", "우수", "경칩", "춘분", "청명", "곡우", "입하", "소만", "망종", "하지", "소서", "대서", "입추", "처서", "백로", "추분", "한로", "상강", "입동", "소설", "대설", "동지", "소한", "대한"];

        static readonly double[] SolarTermLongitudes = [315, 330, 345, 0, 15, 30, 45, 60, 75, 90, 105, 120, 135, 150, 165, 180, 195, 210, 225, 240, 255, 270, 285, 300];

        public class ManseResult
        {
        ...
        public static ManseResult ComputeManse(DateTime localTime, TimeSpan tzOffset)
        {
        ...
        {
            DateTime baseDate = new(1984, 2, 2, 0, 0, 0, DateTimeKind.Utc); // 갑자일 기준
